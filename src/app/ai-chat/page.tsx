  ...
  return (
    <div className={`flex ${isUser ? 'justify-end' : 'justify-start'}`}>
      <div className={`max-w-[80%] rounded-2xl px-4 py-3 text-sm leading-relaxed ${
        isUser
          ? 'bg-[#006899] text-white rounded-tr-sm'
...
export default function AiChatPage() {
  ...
  return (
    <div className="flex flex-col chat-shell bg-[#f3f8fc]">
      {/* Header */}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 w-full max-w-lg">
                {SUGGESTIONS.map((s) => (
                  <button
                    ...
                    className="text-left text-sm text-gray-600 bg-white border border-gray-200 rounded-xl px-4 py-3 hover:border-[#007cb4]/30 hover:bg-accel-lightest/50 hover:text-[#006899] transition-all shadow-sm"
                  >
                    {s}
                  </button>
                ))}
          ...
          <div className="flex gap-2 items-end">
            <div className="flex-1">
              <textarea
                ...
                rows={1}
                disabled={streaming}
                className="w-full text-sm text-gray-800 border border-gray-200 rounded-2xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#007cb4]/20 focus:border-[#007cb4] resize-none disabled:opacity-60 leading-relaxed bg-white"
            ...
            <button
              ...
              className="w-11 h-11 rounded-2xl bg-[#006899] hover:bg-[#004f75] disabled:opacity-40 disabled:cursor-not-allowed text-white flex items-center justify-center transition-colors flex-shrink-0"
            >
              {streaming ? (
